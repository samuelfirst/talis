...
class TalisKafkaBase(metaclass=abc.ABCMeta):
    ...
    @classmethod
    def from_processor(
        cls, data_processor, *args, **kwargs
    ):
        obj = cls(*args, **kwargs)
    ...
    @classmethod
    def from_threaded(
        cls, talis_queue, stop_event, *args, **kwargs
    ):
        obj = cls(*args, **kwargs)
    ...
    @classmethod
    def from_threaded_processor(
        cls, talis_queue, stop_event,
    ...
    def set_data_processor(self, data_processor):
        if not isinstance(data_processor, DataProcessor):
            raise TypeError(
                "The data_processor must be a valid "
                "`talis.DataProcessor` object."
            )
